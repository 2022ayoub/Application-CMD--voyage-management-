...
void booking() {
    ...
    printf("annee:\t"); do { scanf("%d", &a); } while (a < 2022 || a> 2050);
    printf("mois:\t"); do { scanf("%d", &m); } while ((m < 0) || m > 12);
    printf("jour:\t"); do { scanf("%d", &j); } while ((j < 0) || (j > 31));
    printf("heure:\t"); do { scanf("%d", &h); } while (h < 0 || h>24);
    printf("minute:\t"); do { scanf("%d", &mn); } while (mn < 0 || mn>59);
